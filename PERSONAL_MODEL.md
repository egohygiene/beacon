...
id: beacon-personal-model
title: Beacon Personal Model
...
Beacon is designed for and operated by people even when it is primarily a library or automation surface. This document makes its limited human assumptions explicit; it is not a persona catalog, diagnosis, identity model, or prediction engine.
...
- researchers
- technical writers
- organizations publishing governed artifacts
