...
a structured publication specification can produce a polished, citable, accessible artifact and every required distribution package.
...
a word processor replacement or one-format template that hides provenance and publication requirements.
