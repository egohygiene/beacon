...
This document defines reusable semantic language for Beacon's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain editorial, authoritative, accessible, and adaptable across publication identities while allowing product-specific identity to vary inside Ego Hygiene's broader family.
